 ...
 * @author catalina
 */
public class Capcom extends Thread {

    private int dayCounter;
    // JUEGO ESTANDAR 
    private int juegoSGuion = 1;
    private int juegoSNiveles = 2;
    private int juegoSSprites = 6;
    private int juegoSSistemasComplejos = 5;
    private int gananciaS = 400;
//    private String companyName= "Capcom";

    // JUEGO CON DLC: 
    private int maxParaDlc = 3; // lo que se necesita para crear 1 dlc 
    private int cantDlc = 1; // la cantidad de dlc que se tienen que crear
    private int gananciDlc = 750;
    ...
    public Capcom() {
        ...
        this.DesarroladorNarrativa = new Worker(this.getDrive(), 4, 10, 1, this.getNarrativa(), this.getDayDuration(), "narrative", this.getMainMutex(), "Capcom");
        this.DiseñadorNiveles = new Worker(this.getDrive(), 4, 13, 1, this.getNiveles(), this.getDayDuration(), "levels", this.getMainMutex(), "Capcom");
        this.ArtistaSprites = new Worker(this.getDrive(), 1, 20, 1, this.getSprites(), this.getDayDuration(), "sprites", this.getMainMutex(), "Capcom");
        this.ProgramadorLogica = new Worker(this.getDrive(), 1, 8, 5, this.getLogica(), this.getDayDuration(), "systems", this.getMainMutex(), "Capcom");
        this.DesarrolladorDlc = new Worker(this.getDrive(), 2, 17, 1, this.getDlc(), this.getDayDuration(), "dlc", this.getMainMutex(), "Capcom");
        this.miIntegrador = new Integrador(3, this.getDayDuration(), 2, 1, 6, 5, 1, this.getDrive(), this.getMainMutex(), this.getIntegrador());
        this.director = new Director(this.getDayCounter(), this.getDayDuration(), this.getMiIntegrador(), 740, 4000, this.getMainMutex(), "Capcom");
        this.pm = new PM(this.getDayDuration(), this.getDirector(), this.getMainMutex(), "Capcom");
        this.maxEmpleados = 19;
    ...
    public void leerTxt() {
        ...
        String path = "src//Txt//Capcom.txt";
...
//            Main.p.narrativaDisponible3.
             Main.p.salarioMonth3.setText(Integer.toString(this.costoAcumulado));
